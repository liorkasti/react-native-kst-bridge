...
// This would be generated by codegen, but we'll create a temporary interface
interface NativeKSTEventEmitterSpec {
    fun addListener(eventName: String)
    fun removeListeners(count: Double)
    fun emit(eventName: String, args: ReadableArray?)
}

class KSTEventEmitter(private val reactContext: ReactApplicationContext) :
        ReactContextBaseJavaModule(reactContext), NativeKSTEventEmitterSpec {
    ...
    override fun emit(eventName: String, args: ReadableArray?) {
        val eventEmitter =
